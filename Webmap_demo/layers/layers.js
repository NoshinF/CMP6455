...
lyr_SLCo_Healthcare_Facilities_2.set('fieldLabels', {'OBJECTID': 'inline label - always visible', 'FACTYPE': 'inline label - always visible', 'FACILITY_I': 'inline label - always visible', 'FACID': 'inline label - always visible', 'NAME': 'inline label - always visible', 'ADDRESS': 'inline label - always visible', 'CITY': 'inline label - always visible', 'ZIP': 'inline label - always visible', 'TELEPHONE': 'inline label - always visible', 'TYPE': 'inline label - always visible', 'COUNTY': 'inline label - always visible', 'TELEHEALTH': 'inline label - always visible', 'FUNCTIONAL': 'no label', });
